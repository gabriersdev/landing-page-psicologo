const data = [
  ...
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" fill="currentColor" className="bi bi-prescription2"
           viewBox="0 0 16 16">
...
export default function Services() {
  return (
    <section className="relative before:absolute before:inset-0 before:-z-20 before:bg-emerald-800" id={"services"} data-aos="fade-up" data-aos-delay={300}>
